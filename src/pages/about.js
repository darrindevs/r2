    ...
    <Layout>
      ...
      <main>
        ...
        <div id="about" className="container-component mt-5 mb-5">
          ...
          <h5 className='mb-3'>Co-Founder @ <strong>1140nft</strong></h5>
          <p>In August of 2012 I returned to America from London. I was set on not paying rent ever again, so I bought a 1995 Econoline Van. I lived in that Econoline for five years working and saving a downpayment for a home. I finally closed on a property in November 2016. I knew I wanted to develop it to its full potential. </p>
