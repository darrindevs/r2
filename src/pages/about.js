    ...
    <Layout>
      ...
      <main>
        ...
        <div id="about" className="container-component mt-5 mb-5">
          ...
          <p>Even though these key pieces of legislation opened up development possibilities, there was another barrier. The growth potential was not feasible via traditional financing options. It is only now, as Web 3.0 provides new funding mechanisms that the solution presents itself. It’s time to connect Web 3.0 to real estate development.</p>
          <p>We offer the most innovative NFT project in the space today because its value proposition is rooted in <strong>newly created real estate</strong>. <strong>1140nft</strong> is a revolution in the NFT space. There has been no project like it. No NFT has catalyzed fundraising for real estate development and created a DAO with membership benefits derived from new high value assets. </p>
          <p>I believe that people want to invest in real estate development long term and also speculate along the way. <strong>1140nft</strong> is the first project to offer that. High value projects like  are pushing the space in new directions. </p>
        </div>
        <div id="about" className="container-component mt-5 mb-5">
          ...
          <p>I am super passionate about the potential of Web 3 at a technological, financial and cultural level.  The NFT as funding mechanism + member DAO as a vehicle for investor ROI make <strong>1140nft</strong> a really cool project to be involved with. I hope you join us on our journey.</p>
          <p><a href="https//:twitter.com/helloDarrin" target="blank">Get in touch</a>.</p>
        </div>
        <div id="about" className="container-component mt-5 mb-5">
          <p>* Bradley and Darrin have known each for 35 years. <i>(Ask about the Food Fight).</i> </p>
          <p>Follow <strong>1140nft</strong> on Twitter.</p>
