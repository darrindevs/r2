...
const Hero = () => (
    <div id="hero" className="container-component mt-5">
      ...
      <h3 id="tagline" className='mb-3 mt-3'>The World's First NFT Funded<br></br> 
      Real Estate Development Project</h3>
      <h2 className="mt-3 mb-3" id="introducing"><i>Introducing</i><span> 1140nft</span></h2>
